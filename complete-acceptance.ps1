...
$sessionHash=Need-Sha ([string]$a.physical_clone.session_sha256) 'physical_clone.session_sha256';$readinessHash=Need-Sha ([string]$a.physical_clone.readiness_sha256) 'physical_clone.readiness_sha256'
$sessionEvidence=Join-Path $dir 'bodyrig-physical-clone-session.json';$readinessEvidence=Join-Path $dir 'bodyrig-rig-readiness.json'

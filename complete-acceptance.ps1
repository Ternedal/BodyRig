...
Write-Host "BodyRig release acceptance: PASS | skin=$($a.skin_qa.automated_assessment) | Windows=$($wp.Value.device_model) | Quest=$($qp.Value.device_model)";Write-Host "Release report: $Output";exit 0
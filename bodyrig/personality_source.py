...
def preview_source_personality_exemplars(
    ...
    *,
    ...
    Transcript text can contain other speakers even when the media is bound to
    the selected performer. The preview therefore remains non-authoritative
    until an operator explicitly confirms speaker identity and style-only use.
    """

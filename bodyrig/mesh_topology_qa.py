...
# These thresholds were calibrated against the physically observed membrane/fan
# failure class. Tiny local high-aspect triangles alone are not a rejection
# signal; the failure requires physically large body-scale edges/candidates.
...
def analyze_avatar(avatar: bytes, *, body_id: str, package_sha256: str) -> dict[str, Any]:
    ...
    return {
        ...
        "mesh": {
            ...
            "bounds": {"x": round(extent_x, 8), "y": round(extent_y, 8), "z": round(extent_z, 8)},
        },
        "triangle_geometry": {

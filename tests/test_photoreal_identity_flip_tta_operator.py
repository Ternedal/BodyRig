...
SCRIPT = ROOT / "diagnose-photoreal-v2-identity-flip-tta.ps1"


def test_flip_tta_operator_preserves_diagnostic_authority_boundary() -> None:
    source = SCRIPT.read_text(encoding="utf-8")

    assert "IDENTITY FLIP-TTA DIAGNOSTIC" in source
...
def test_flip_tta_operator_powershell_parses_when_pwsh_available() -> None:

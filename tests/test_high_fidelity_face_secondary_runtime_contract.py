...
def test_runtime_module_is_review_only_and_keeps_all_five_components_partial() -> None:
    ...
    for required in (
        ...
        '"source-derived-dental-graft-v1"',
        'embedded.get("fineIdentityAttestationSha256") != value.get("fineIdentityAttestationSha256")',
        'embedded.get("fineIdentityAuthoritySha256") != value.get("fineIdentityAuthoritySha256")',
        'embedded.get("dentalSourceReferences") != value.get("dentalSourceReferences")',
...
def test_windows_wrapper_is_clean_checkout_bound_and_cleans_only_new_output() -> None:
    ...
    for required in (
        ...
        "bodyrig.high_fidelity_face_secondary_runtime_cli",
        "\"build\"",
        ...
        "DentalCandidatePath",
        "DentalResultPath",
        "SOURCE-DERIVED DENTAL / REVIEW REQUIRED",

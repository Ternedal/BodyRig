...
def test_continuation_starts_at_frame_measurement_without_recalibration() -> None:
...
def test_continuation_requires_persisted_uncalibrated_evidence() -> None:
    source = SCRIPT.read_text(encoding="utf-8")
...
def test_continuation_copies_authority_artifacts_with_hash_verification() -> None:
    source = SCRIPT.read_text(encoding="utf-8")

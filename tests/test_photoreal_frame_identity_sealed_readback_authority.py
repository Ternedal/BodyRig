...
from bodyrig.photoreal_identity_calibration_provenance import bind_negative_inventory_provenance
...
def test_sealed_readback_rejects_provenance_seal_tamper() -> None:
    bank = _bank()
    calibration = copy.deepcopy(_sealed_calibration(bank))
    calibration["identity_calibration_provenance_sha256"] = "0" * 64

...
def test_renderer_records_absent_as_well_as_physically_drawable_components() -> None:
    ...
    for marker in (
        ...
        'HasDrawableMaterial(renderer)',
        'bounds.extents.sqrMagnitude < MinimumDrawableBoundsSqrMagnitude',
        'bounds.SqrDistance(head.position)',
    ):

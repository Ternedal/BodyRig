...
Suite-modellen forvælges kun, hvis det eksakte modelnavn stadig findes i den aktuelle ModelRig-library. Hvis modellen er væk eller omdøbt, nulstiller Person Studio modelvalget og kræver et manuelt valg i stedet for lydløst at vælge en anden model. Handoffet venter på den live model-library, før modellen anvendes, og tabskiftet genindlæser ikke biblioteket bagefter.
